...
int main() {
    ...
    printf("Jawaban:\n");
    printf("Integer(ex: int), Floating-point(ex: float), Character(ex:char) , Boolean(ex: bool)\n");
       

    /* Nomor 2 [5 point] */
    printf("2. Sebutkan perbedaan fungsi dan prosedur!\n");
    printf("Jawaban:\n");
    printf("Fungsi adalah subprogram yang akan mengembalikan suatu value\n");
    printf("Prosedur adalah subprogram yang akan mengubah suatu state dari program\n");
