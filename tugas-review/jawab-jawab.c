...
int main() {
    ...
    printf("Jawaban:\n");
    printf("int, char, double, float\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris

    /* Nomor 2 [5 point] */
    printf("2. Sebutkan perbedaan fungsi dan prosedur!\n");
    printf("Jawaban:\n");
    printf("Perbedaan fungsi dan prosedur terletak pada pengembalian nilai. Fungsi mengembalikan nilai atau memiliki nilai keluarakan sedangkan prosedur tidak\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris

    /* Nomor 3 [5 point] */
    int **val;
    printf("3. Apa tipe data dari deklarasi variabel di atas?");
    printf("Jawaban:\n");
    printf("integer dari pointer ke pointer\n");
