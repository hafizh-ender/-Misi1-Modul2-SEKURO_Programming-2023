...
int main() {
    ...
    printf("Jawaban:\n");
    printf("integer, character, double, float, void\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris

    /* Nomor 2 [5 point] */
    printf("2. Sebutkan perbedaan fungsi dan prosedur!\n");
    printf("Jawaban:\n");
    printf("fungsi adalah subprogram yang mereturn value, sedangkan prosedur tidak mereturn value\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris

    /* Nomor 3 [5 point] */
    int **val;
    printf("3. Apa tipe data dari deklarasi variabel di atas?");
    printf("Jawaban:\n");
    printf("pointer ke pointer ke int\n");
