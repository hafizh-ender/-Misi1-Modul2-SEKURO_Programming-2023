...
int main() {
    ...
    printf("Jawaban:\n");
    printf("integer, floating point, character, boolean\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris

    /* Nomor 2 [5 point] */
    printf("2. Sebutkan perbedaan fungsi dan prosedur!\n");
    printf("Jawaban:\n");
    printf("prosedur tidak dapat mengembalikan suatu nilai dari tipe tertentu sedangkan fungsi bisa\n"); // lengkapi di sini. jawaban tidak dibatasi dalam 1 baris

    /* Nomor 3 [5 point] */
    int **val;
    printf("3. Apa tipe data dari deklarasi variabel di atas?");
    printf("Jawaban:\n");
    printf("pointer dari pointer dari val atau bisa juga dibilang sesuatu yang merujuk pada sesuatu yang merujuk pada val\n");
